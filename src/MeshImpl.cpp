...
namespace Ra
{
    ...
    void MeshImpl::LoadMesh(const std::string& path)
    {
    ...
    void MeshImpl::ForEashSubmesh(const std::function<void(SubMesh&) >& func)
    {
    ...
    std::string MeshImpl::GetPath() const
    {
        return m_Path.string();
    }

    void MeshImpl::ProcessNode_(aiNode* node, const aiScene* scene)
    {
    ...
    SubMesh MeshImpl::ProcessSubMesh_(aiMesh* subMesh, const aiScene* scene)
    {
